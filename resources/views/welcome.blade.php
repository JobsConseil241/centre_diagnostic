...
{{--                    </div>--}}
                    ...
                    <div style="position: relative;visibility:visible" class="col-md-6 col-lg-4 mb-3 text-end rounded">
{{--                        <a href="#" @if($agence->has_consult === 0) class="tablinks disabled" @endif id="consultData">--}}
                        <a href="https://centre-diagnostic.com/contacts/" @if($agence->has_consult === 0) class="tablinks disabled" @endif width="300">
...
{{--                    </div>--}}
                    ...
                    <div style="position: relative;visibility:visible" class="col-md-6 col-lg-4 mb-2 text-start rounded">
...
<script>
    ...
    jQuery( document ).ready(function() {
        ...
        const INACTIVITY_TIME = 60 * 1000; // 10 secondes
        let inactivityTimer;
