                                                ...
                                                <div class="checkbox-grid-container">
                                                    <div class="checkbox-grid mx-auto">
                                                        @foreach($field->options as $option)
                                                            <div>
                                                                <input type="radio" name="{{ $field->name }}" id="{{ $option->libelle }}{{ $field->id }}" class="form-check-input" value="{{ $option->libelle }}">
                                            ...
                                            @elseif($field->type === 'checkbox')
                                                <div class="checkbox-grid-container">
                                                    <div class="checkbox-grid mx-auto">
                                                        @foreach($field->options as $option)
                                                            <div>
                                                                <input type="checkbox" class="form-check-input" id="{{ $option->libelle }}{{ $field->id }}" name="{{ $field->name }}[]" value="{{ $option->libelle }}">
                                                                <label class="form-check-label" for="{{ $option->libelle }}{{ $field->id }}">{{ $option->libelle }}</label>
                                                            </div>
                                                        @endforeach
                                                    </div>
                                            ...
                                            @elseif($field->type === 'radio')
                                                ...
                                                <div class="checkbox-grid-container">
                                                    <div class="checkbox-grid mx-auto">
                                                        @foreach($field->options as $option)
                                                            <div>
                                                                <input type="radio" id="{{ $option->libelle }}{{ $field->id }}" name="{{ $field->name }}" class="form-check-input" value="{{ $option->libelle }}">
                                                                <label class="form-check-label" for="{{ $option->libelle }}{{ $field->id }}">{{ $option->libelle }}</label>
                                                            </div>
                                                        @endforeach
                                                    </div>
                                            ...
                                            @elseif($field->type === 'checkbox')
                                                ...
                                                <div class="checkbox-grid-container">
                                                    <div class="checkbox-grid mx-auto">
                                                        @foreach($field->options as $option)
                                                            <div>
                                                                <input type="checkbox" id="{{ $option->libelle }}{{ $field->id }}" class="form-check-input" name="{{ $field->name }}[]" value="{{ $option->libelle }}">
                                                                <label class="form-check-label" for="{{ $option->libelle }}{{ $field->id }}">{{ $option->libelle }}</label>
                                                            </div>
                                                        @endforeach
                                                    </div>
